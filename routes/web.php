...
Route::group(['middleware' => ['role:user']], function () {
    ...
    Route::delete('/del/{id}', [TemplateController::class, 'destroy'])->name('template.delete');
    ...
    Route::post('/wishlist/{id}', [KeranjangController::class, 'store'])->name('wishlist.store');
    Route::delete('/wishlist/{id}', [KeranjangController::class, 'destroy'])->name('wishlist.destroy');
});
